...
# ------------------------
var bg_textures := {
	"default": preload("res://img/conversation/background/default.png"),
	"shrine": preload("res://img/conversation/background/shrine.png"),
	"shop": preload("res://img/conversation/background/shop.png"),
	"forest": preload("res://img/conversation/background/forest.png")
}
...
var character_defs := {
	"reimu": {
		...
		"expressions": {
			"neutral": {
				"eyes": preload("res://img/conversation/char/reimu/eyelashes/normal_right.png"),
				"mouth": preload("res://img/conversation/char/reimu/mouths/mood.png")
			},
			"happy": {
				"eyes": preload("res://img/conversation/char/reimu/expressions/annoyed.png"),
				"mouth": preload("res://img/conversation/char/reimu/mouths/happy.png")
			},
			"sad": {
				"eyes": preload("res://img/conversation/char/reimu/eyelashes/worried_left.png"),
